    ...
    if (!navBar) {
        ...
        if (showNavigation) {
            if (options.zoomable) {
                ...
                var ziIcon = document.createElement("i");
                ziIcon.className = "fa fa-search-plus";
                ziIconSpan.appendChild(ziIcon);
                ...
                var zoIcon = document.createElement("i");
                zoIcon.className="fa fa-search-minus";
                zoIconSpan.appendChild(zoIcon);
            ...
            if (options.moveable) {
                ...
                var mlIcon = document.createElement("i");
                mlIcon.className = "fa fa-arrow-circle-left";
                mlIconSpan.appendChild(mlIcon);
                ...
                var mrIcon = document.createElement("i");
                mrIcon.className = "fa fa-arrow-circle-right";
                mrIconSpan.appendChild(mrIcon);
